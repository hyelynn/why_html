  ...
  var b = "starRating",
    ...
    f = {
      ...
      getIndex: function (b) {
        ...
        var g = c.index() - ("left" === e ? 0.5 : 0);
        return (
          (g = 0.5 > g && b.offsetX < d / 4 ? -1 : g),
      ...
      paintStars: function (b, c) {
        ...
        a.each(
          this.$stars,
          function (h, i) {
            (d = a(i).find('[data-side="left"]')),
              (e = a(i).find('[data-side="right"]')),
              (f = g = b >= h ? c : "empty"),
              (f = h - b === 0.5 ? c : f),
      ...
      renderMarkup: function () {
        for (
          var a = this.settings,
            b = a.baseUrl ? location.href.split("#")[0] : "",
            c =
              ...
              this.getSvgDimensions(a.starShape) +
              " stroke-width:" +
              a.strokeWidth +
      ...
      getVectorPath: function (a, b) {
        return "rounded" === b.starShape
          ? this.getRoundedVectorPath(a, b)
          : this.getSpikeVectorPath(a, b);
      },
    ...
    g = {
      ...
      setRating: function (c, d) {
        var e = "plugin_" + b,
          f = a(this),
          g = f.data(e);
        c > g.settings.totalStars ||
          0 > c ||
          (d && (c = Math.round(c)), g.applyRating(c));
      },
      getRating: function () {
        var c = "plugin_" + b,
          d = a(this),
      ...
      resize: function (c) {
        var d = "plugin_" + b,
          ...
          g = f.$stars;
        return 1 >= c || c > 200
          ? void console.log("star size out of bounds")
      ...
      setReadOnly: function (c) {
        var d = "plugin_" + b,
          ...
          f = e.data(d);
        c === !0
          ? f.$stars.off("mouseover mouseout click")
          : ((f.settings.readOnly = !1), f.addListeners());
      },
    };
