$(document).ready(function(){
    ...
    $.ajax({
        ...
        if(index <= 3){ //4개 까지는 보여줌
            ...
            "</div>"+
            "<img src='/why_html/img/section-1-photo.jpg' class='card-img-top rounded-0' srcset='/why_html/img/section-1-photo@2x.jpg 2x, /why_html/img/section-1-photo@3x.jpg 3x' alt=''>"+
